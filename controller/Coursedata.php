...
$columns = array(
    ...
    array(
        ...
        'formatter' => function($id) {
            ...
            <button class="btn btn-danger btn-sm" onclick="if(confirm(\'Are you sure you want to delete this course?\')) window.location.href=\'../controller/DeleteCourse.php?id=' . $id . '\'">Delete</button>';
        }
    )
);
